...
ORG_WEBRTC_WRAPPER_C_EXPORT_API org_webRtc_MediaSource_t ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_MediaSource_wrapperCreate_MediaSourceWithNativeSource(zs_Any_t source);
ORG_WEBRTC_WRAPPER_C_EXPORT_API zs_Any_t ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_MediaSource_get_source(org_webRtc_MediaSource_t wrapperThisHandle);
