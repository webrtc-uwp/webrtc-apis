...
ORG_WEBRTC_WRAPPER_C_EXPORT_API org_webRtc_VideoData_t ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_VideoData_wrapperCreate_VideoData(uint64_t size);
...
ORG_WEBRTC_WRAPPER_C_EXPORT_API void ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_VideoData_get_data8bit(
  ...
  uintptr_t buffer,
  binary_size_t size);
ORG_WEBRTC_WRAPPER_C_EXPORT_API void ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_VideoData_set_data8bit(
  org_webRtc_VideoData_t wrapperThisHandle,
  uintptr_t buffer,
  binary_size_t size);
...
ORG_WEBRTC_WRAPPER_C_EXPORT_API void ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_VideoData_get_data16bit(
  ...
  uintptr_t buffer,
  binary_size_t size);
ORG_WEBRTC_WRAPPER_C_EXPORT_API void ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_VideoData_set_data16bit(
  org_webRtc_VideoData_t wrapperThisHandle,
  uintptr_t buffer,
  binary_size_t size);
