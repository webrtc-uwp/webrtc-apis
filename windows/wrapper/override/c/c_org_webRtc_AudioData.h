...
ORG_WEBRTC_WRAPPER_C_EXPORT_API std_list_int16_t_t ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_AudioData_get_data(org_webRtc_AudioData_t wrapperThisHandle);
ORG_WEBRTC_WRAPPER_C_EXPORT_API void ORG_WEBRTC_WRAPPER_C_CALLING_CONVENTION org_webRtc_AudioData_set_data(org_webRtc_AudioData_t wrapperThisHandle, std_list_int16_t_t value);
