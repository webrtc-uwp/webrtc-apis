    ...
    namespace org {
      namespace webRtc {
        ...
        struct WebRtcFactory : public wrapper::org::webRtc::WebRtcFactory
        {
          ...
          ZS_DECLARE_TYPEDEF_PTR(::webrtc::VideoDeviceCapturerFactory, UseVideoDeviceCaptureFactory);
          ...
          UseVideoDeviceCaptureFactoryPtr videoDeviceCaptureFactory_;
          ...
          UseVideoDeviceCaptureFactoryPtr videoDeviceCaptureFactory() noexcept;
