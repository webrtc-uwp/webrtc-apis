    ...
    namespace org {
      namespace webRtc {
        ...
        struct RTCAudioSenderStats : public wrapper::org::webRtc::RTCAudioSenderStats
        {
          ...
          ZS_NO_DISCARD() static Optional< double > get_echoReturnLoss(const NativeStats *native) noexcept;
          ZS_NO_DISCARD() static Optional< double > get_echoReturnLossEnhancement(const NativeStats *native) noexcept;
          ZS_NO_DISCARD() static unsigned long long get_totalSamplesSent(const NativeStats *native) noexcept;
