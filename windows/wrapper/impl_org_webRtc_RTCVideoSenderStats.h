    ...
    namespace org {
      namespace webRtc {
        ...
        struct RTCVideoSenderStats : public wrapper::org::webRtc::RTCVideoSenderStats
        {
          ...
          ZS_NO_DISCARD() static unsigned long get_framesCaptured(const NativeStats *native) noexcept;
          ZS_NO_DISCARD() static unsigned long get_framesSent(const NativeStats *native) noexcept;
          ZS_NO_DISCARD() static unsigned long get_hugeFramesSent(const NativeStats *native) noexcept;
          ZS_NO_DISCARD() static unsigned long get_keyFramesSent(const NativeStats *native) noexcept;
